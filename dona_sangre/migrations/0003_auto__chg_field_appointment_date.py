...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Appointment.date'
        db.alter_column(u'dona_sangre_appointment', 'date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Appointment.date'
        db.alter_column(u'dona_sangre_appointment', 'date', self.gf('django.db.models.fields.DateTimeField')())

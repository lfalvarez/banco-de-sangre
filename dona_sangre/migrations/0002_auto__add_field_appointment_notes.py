...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Appointment.notes'
        db.add_column(u'dona_sangre_appointment', 'notes',
                      self.gf('django.db.models.fields.TextField')(default=u''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Appointment.notes'
        db.delete_column(u'dona_sangre_appointment', 'notes')
    ...
    models = {
        ...
        u'dona_sangre.appointment': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 30, 0, 0)'}),
